...
public class EditInformation {
    ...
    public static void edit_stock_information(){
        ...
        if (product_id.equals("")) {sc.close(); return;}
        ...
        if (!found) {
            ...
            while (true){
                ...
                System.out.println("Type 0 to ESC ");
                outlet = sc.nextInt();
    ...
    public static void edit_sales_information(){
        ...
        if (found.size() < 1) {sc.close(); return;}   // return if no transactions found
        else{
            if (found.size() > 1) {
