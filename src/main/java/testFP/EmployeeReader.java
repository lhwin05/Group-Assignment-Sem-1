...
reads from Employee.csv to get info about employee before creating employee objects using the parameters
saveNewEmployee is to append the Employeee.csv file and add new employees
checks for duplicated ID and authenticate logins by checking the array of employees
*/
